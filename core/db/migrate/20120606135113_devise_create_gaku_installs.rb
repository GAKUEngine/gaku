class DeviseCreateGakuInstalls < ActiveRecord::Migration
  def change
    ...
    add_index :gaku_installs, :email,                :unique => true
    add_index :gaku_installs, :reset_password_token, :unique => true
