...
batch_create(@count[:disposals]) do
  ...
  Gaku::Attachment.create!(name: 'Attachment Name', attachable: exam_portion, asset: File.open(File.join(File.dirname(__FILE__), '..', 'images', '120x120.jpg')), is_deleted: true)
end
