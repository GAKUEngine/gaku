...
describe Gaku::Grading::Single::Ordinal do
  ...
  subject { described_class.new(exam, student, grading_method.criteria) }
  ...
  describe 'with exam portion scores' do
    ...
    it 'calculates grade A from exam_portion_scores' do
      create(:exam_portion_score, score: 90, student:student, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 90, student:student, exam_portion: exam_portion2)
    ...
    it 'calculates grade B from exam_portion_scores' do
      ...
      create(:exam_portion_score, score: 80, student:student, exam_portion: exam_portion2)

      expect(subject.grade_exam).to eq({ id: student.id, score: 'B' })
    end

    it 'calculates grade C from exam_portion_scores' do
      create(:exam_portion_score, score: 60, student:student, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 60, student:student, exam_portion: exam_portion2)

      expect(subject.grade_exam).to eq({ id: student.id, score: 'C' })
    end

    it 'calculates grade D from exam_portion_scores' do
      create(:exam_portion_score, score: 40, student:student, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 40, student:student, exam_portion: exam_portion2)

      expect(subject.grade_exam).to eq({ id: student.id, score: 'D' })
    end

    it 'calculates grade F from exam_portion_scores' do
      create(:exam_portion_score, score: 10, student:student, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 15, student:student, exam_portion: exam_portion2)

      expect(subject.grade_exam).to eq({ id: student.id, score: 'F' })
    end

    it 'didnt show grade if percentage is bellow last criteria' do
      create(:exam_portion_score, score: 1, student:student, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 1, student:student, exam_portion: exam_portion2)
