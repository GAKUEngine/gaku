...
describe 'CourseGroups' do
  ...
  context 'show, edit, delete' do
    ...
    it 'should edit course group from index view', :js => true do 
      ...
      within('#course_groups_index_table tbody') { click_on 'Edit' }
    ...
    pending 'should edit course group from show view', :js => true do #TODO to be implemented
    ...
    it 'should delete the course group', :js => true do 
      ...
      wait_until { page.should have_content('Add Course') } #TODO change that
    ...
    pending 'should return to class_groups index when back selected' do #TODO to be implemented
      visit course_group_path(@course_group)
      click_on('Back')
      page.should have_content ('Course Groups Listing')
    end
  end
end