...
describe Gaku::Grading::Single::Score do
  ...
  let(:exam_portion_score1) do
    create(:exam_portion_score, score: 5, student:student, exam_portion: exam_portion1)
  end
  let(:exam_portion_score2) do
    create(:exam_portion_score, score: 10, student:student, exam_portion: exam_portion2)
  end
