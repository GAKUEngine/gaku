...
describe Gaku::Grading::Collection::Interval do
  ...
  describe 'caluclates' do
    ...
    it 'students with same score get same interval criteria' do
      create(:exam_portion_score, score: 50,  student:student1, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 50,  student:student1, exam_portion: exam_portion2)
      ...
      create(:exam_portion_score, score: 40,  student:student3, exam_portion: exam_portion1)
      create(:exam_portion_score, score: 40, student:student3, exam_portion: exam_portion2)
      subject = described_class.new(exam, [student1, student2, student3], grading_method.criteria)
