...
Gaku::StudentAddress.create(:student_id => student.id, :address_id => address.id)
...
Gaku::GuardianAddress.create(:guardian_id => guardian.id, :address_id => guardian_address.id)
